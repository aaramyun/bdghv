...
Notice that the above scheme is correct as is proved in \cite{KLYC2013} with the definition of correctness for
...
\subsection{Applications to Secure Large Integer Arithmetic}
...
As is mentioned earlier, $\CDGHV$ scheme supports arithmetic operations
on $\Z_Q$, $Q=Q_0\cdots Q_{\ell-1}$ when all $Q_i$'s are pairwise coprime.
...
Basic Science Research Program through the National Research Foundation of Korea (NRF) funded by the Ministry of Education, Science and Technology (No. 2012R1A1A2039129).
%
