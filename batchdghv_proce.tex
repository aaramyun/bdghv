...
$q_i\gets\Z\cap[0,q_0)$, $r'_{i,j}\gets\Z\cap(-2^\rho,2^\rho)$, determine $b\in\{0,1\}$ from $z=x+r\cdot b\mod x_0$ where $x\leftarrow\D$ and $r\leftarrow\Z\cap[0,x_0)$.
\end{definition}
...
$\gamma$-bit integers:  
\[ \D_\rho(p,q_0) = \left\{ \Choose q\leftarrow [0, q_0),
...
determine $b\in\{0,1\}$ from $z=x+r\cdot b\mod x_0$ where $x\leftarrow\D_{\rho}(p,q_0)$ and $r\leftarrow\Z\cap[0,x_0)$.
\end{definition}
